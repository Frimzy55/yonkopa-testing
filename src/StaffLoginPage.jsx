...
const StaffLoginPage = () => {
  ...
  const canSubmit = Object.keys(errors).length === 0 && formData.email && formData.password && !isSubmitting;
  ...
  return (
    <div className="login-page">
      ...
      <div className="login-image">
        ...
        {showChristmasTree && <img src={christmasTree} alt="Christmas Tree" className="christmas-tree" />}
      </div>
