...
const AdminDashboard = () => {
  ...
  const { contentAreaRef, saveCurrentScrollPosition } =
    useScrollPersistence(navigation);
  ...
  const handleSubMenuClick = useCallback(
    (parentMenu, subMenuName, hasNestedOrReports, e) => {
      if (e) e.preventDefault();
      handleSubMenuClickBase(
        parentMenu,
        subMenuName,
  ...
  const handleNestedMenuClick = useCallback(
    (parentMenu, subMenuName, nestedMenuName, e) => {
      if (e) e.preventDefault();
      handleNestedMenuClickBase(
        parentMenu,
        subMenuName,
        nestedMenuName,
        saveCurrentScrollPosition,
  ...
  const isMainMenuActive = useCallback(
    (item) => {
      return (
        navigation.activeMenu === item.name &&
  ...
  const isSubMenuActive = useCallback(
    (subItem) => {
      return (
        navigation.activeSubMenu === subItem.name &&
        !navigation.activeNestedMenu &&
        !navigation.activeReportName
      );
    },
  ...
  const isReportActive = useCallback(
    (reportName) => navigation.activeReportName === reportName,
    [navigation],
  );
  const isNestedActive = useCallback(
    (nestedName) => navigation.activeNestedMenu === nestedName,
    [navigation],
  );
  ...
  const renderMyApprovalsContent = useCallback(() => {
      ...
      return (
        <div className="bg-light p-4 rounded-3 text-center">
          ...
          <p className="mt-2 mb-0">
            Please select an approval category from the menu.
          </p>
        </div>
      );
    }
    ...
    if (
      ...
      activeNestedMenu === "Approve Daily Collections"
    ) {
    ...
    if (
      activeSubMenu === "Internal Accounts" &&
      internalAccountsApprovals[activeNestedMenu]
    ) {
    ...
    if (
      activeSubMenu === "Batch Uploads" &&
      batchUploadApprovals[activeNestedMenu]
    ) {
  ...
  const renderContent = useCallback(() => {
    const { activeMenu, activeSubMenu, activeNestedMenu, activeReportName } =
      navigation;
    ...
    if (activeMenu === "Customer") {
      if (activeSubMenu === "Create Customer") {
        ...
        return (
          <div className="bg-light p-4 rounded-3 text-center">
            ...
            <p className="mt-2 mb-0">
              Please select a customer type to create.
            </p>
          </div>
        );
      }
      ...
      return (
        <div className="bg-light p-4 rounded-3 text-center">
          ...
          <p className="mt-2 mb-0">
            Please select a customer management option from the menu.
          </p>
        </div>
      );
    }
    ...
    if (activeMenu === "Account") {
      ...
      return (
        <div className="bg-light p-4 rounded-3 text-center">
          ...
          <p className="mt-2 mb-0">
            Please select an account management option from the menu.
          </p>
        </div>
      );
    }
    ...
    if (activeMenu === "Teller") {
      ...
      return (
        <div className="bg-light p-4 rounded-3 text-center">
          ...
          <p className="mt-2 mb-0">
            Please select a teller transaction option from the menu.
          </p>
        </div>
      );
    }
  ...
  return (
    ...
    if (activeMenu === "Investment") {
      ...
      return (
        <div className="bg-light p-4 rounded-3 text-center">
          ...
          <p className="mt-2 mb-0">
            Please select an investment option from the menu.
          </p>
        </div>
      );
    }
    ...
    if (activeMenu === "Internal Accounts") {
      ...
      return (
        <div className="bg-light p-4 rounded-3 text-center">
          ...
          <p className="mt-2 mb-0">
            Please select an internal accounts option from the menu.
          </p>
        </div>
      );
    }
    ...
    if (activeMenu === "Admin") {
      ...
      return (
        <div className="bg-light p-4 rounded-3 text-center">
          ...
          <p className="mt-2 mb-0">
            Please select an admin option from the menu.
          </p>
        </div>
      );
    }
    ...
    if (activeMenu === "Reports") {
      const reportComponents = {
        ...
        "Customer by Relationship Officer Report":
          CustomerByRelationshipOfficerReport,
    ...
    if (activeMenu === "Batch Upload") {
      ...
      return (
        <div className="bg-light p-4 rounded-3 text-center">
          ...
          <p className="mt-2 mb-0">
            Please select a batch upload option from the menu.
          </p>
        </div>
      );
    }
    ...
    if (activeMenu === "System Settings") {
      ...
      return (
        <div className="bg-light p-4 rounded-3 text-center">
          ...
          <p className="mt-2 mb-0">
            Please select a system settings option from the menu.
          </p>
        </div>
      );
    }
    ...
    return (
      <div className="bg-light p-4 rounded-3 text-center">
        <i
          className={`bi ${menuItems.find((m) => m.name === activeMenu)?.icon || "bi-grid"} fs-1 text-secondary`}
        ></i>
        <p className="mt-2 mb-0">
            ...
            <div className="p-3 p-md-4">
              ...
              <div className="card border-0 shadow-sm">
                <div className="card-header bg-white border-0 py-3">
                  <h5 className="mb-0 fw-semibold fs-6 fs-md-5">
